 ...
 */
export function hasCustomPrompts(queueConfig?: QueueConfiguration): boolean {
 ...
 * - If parsing fails or structure is invalid, return an empty array.
 */
 ...
 */
export function areResponsesValid(responses: string[], prompts: string[]): boolean {
  return (
